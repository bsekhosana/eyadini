        ...
        selector.each(function (index) {
                                ...
                                if ($(result.data).get(a).count == null && settings.skipEmptyAlbums) {
                                    ...
                                    $(albumListItem).click(function () {
                                        ...
                                        previewContainer.append($("<img>", {
                                            ...
                                            height: 32,
                                            width: 32,
                                            src: settings.pluginImagesPath + "../img/back.png",
            ...
            function initLightboxes(photoLink) {
                ...
                if (overlay.length == 0) {
                    ...
                    overlay.append($("<img>", { class: "fb-preview-img-prev", src: settings.pluginImagesPath + "../img/prev-icon.png" }));
                    overlay.append($("<img>", { class: "fb-preview-img-next", src: settings.pluginImagesPath + "../img/next-icon.png" }));
